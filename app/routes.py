...
from .controllers.predict import DoModelTraining, RegisterModelTraining, RemoveJob, ReturnHealthData, ReturnPredictedData, ReturnHealth
...
def create_routes(api: Api):
    ...
    api.add_resource(ReturnHealthData, '/health_data/<time_range>')
